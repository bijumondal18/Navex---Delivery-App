...
class _AvailableRoutesScreenState extends State<AvailableRoutesScreen> {
  ...
  Future<void> _openCalendar() async {
    final DateTime? pickedDate = await showDatePicker(
      ...
      initialDate: _selectedDate ?? DateTime.now(), // current date
      firstDate: DateTime.now(),   // no previous date allowed
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(
                       DateTimeUtils.getFormattedSelectedDate(_selectedDate?? DateTime.now()) ?? DateTimeUtils.getFormattedCurrentDate(),
                        style: Theme.of(
                          context,
